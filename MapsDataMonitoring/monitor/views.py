...
def test(request):
   ...
   "address_components":[
      {
         "long_name":"Domingo Velez Street",
         "short_name":"Domingo Velez St",
         "types":[
            "route"
         ]
      },
      {
         "long_name":"Cagayan de Oro",
         "short_name":"CDO",
         "types":[
            "locality",
            "political"
   ...
   "geometry":{
      "location":{
         "lat":8.479841999999998,
         "lng":124.647058
      },
      "viewport":{
         "northeast":{
            "lat":8.481143730291501,
            "lng":124.6484829302915
         },
         "southwest":{
            "lat":8.478445769708497,
            "lng":124.6457849697085
         }
      }
   },
   "icon":"https://maps.gstatic.com/mapfiles/place_api/icons/generic_business-71.png",
   "id":"0cd35cb90b52ce69538d3ffe95efd6ec56ff355f",
   "international_phone_number":"+63 88 881 2729",
   "name":"Syntactics Inc",
   "opening_hours":{
      "open_now":True,
      "periods":[
