...
from django_celery_beat import managers, validators
...
class PeriodicTask(models.Model):
    ...
    name = models.CharField(
        ...
        help_text=_('Useful Test description'),
    )
    ...
    args = models.TextField(
        _('Arguments'), blank=True, default='["DATA"]',
        help_text=_('JSON encoded positional arguments'),
    )
    kwargs = models.TextField(
        _('Keyword arguments'), blank=True, default='{}',
        help_text=_('Do not modify auto assigned data, it may break the scheduling process'),
    )
